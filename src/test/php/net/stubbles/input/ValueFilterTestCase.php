...
class ValueFilterTestCase extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals(303, $this->createValueFilter(null)->asInt(null, 303));
    }
    ...
    {
        $this->assertNull($this->createValueFilter(null)->asInt(null, 303, true));
    }
    ...
    {
        $this->createValueFilter(null)->asInt(null, 303, true);
    ...
    {
        $this->assertNull($this->createValueFilter(4)->asInt(NumberRange::minOnly(5)));
    }
    ...
    {
        $this->createValueFilter(4)->asInt(NumberRange::minOnly(5));
    ...
    {
        $this->assertEquals(3.03, $this->createValueFilter(null)->asFloat(null, 3.03));
    }
    ...
    {
        $this->assertNull($this->createValueFilter(null)->asFloat(null, 3.03, true));
    }
    ...
    {
        $this->createValueFilter(null)->asFloat(null, 3.03, true);
        $this->assertTrue($this->paramErrors->existForWithId('bar', 'FIELD_EMPTY'));
    }
    ...
    {
        $this->assertNull($this->createValueFilter(2.5)->asFloat(NumberRange::minOnly(5)));
    }
    ...
    {
        $this->createValueFilter(2.5)->asFloat(NumberRange::minOnly(5));
        $this->assertTrue($this->paramErrors->existFor('bar'));
    }
    ...
    {
        $this->assertEquals(313, $this->createValueFilter('3.13')->asFloat(null, null, false, 2));
    ...
    {
        $this->assertEquals('baz', $this->createValueFilter(null)->asString(null, 'baz'));
    }
    ...
    {
        $this->assertNull($this->createValueFilter(null)->asString(null, 'baz', true));
    }
    ...
    {
        $this->createValueFilter(null)->asString(null, 'baz', true);
        $this->assertTrue($this->paramErrors->existForWithId('bar', 'FIELD_EMPTY'));
    }
    ...
    {
        $this->assertNull($this->createValueFilter('foo')->asString(LengthRange::minOnly(5)));
    }
    ...
    {
        $this->createValueFilter('foo')->asString(LengthRange::minOnly(5));
        $this->assertTrue($this->paramErrors->existFor('bar'));
    }
    ...
    {
        $this->assertEquals('baz', $this->createValueFilter(null)->asText(null, 'baz'));
    }
    ...
    {
        $this->assertNull($this->createValueFilter(null)->asText(null, 'baz', true));
    }
    ...
    {
        $this->createValueFilter(null)->asText(null, 'baz', true);
        $this->assertTrue($this->paramErrors->existForWithId('bar', 'FIELD_EMPTY'));
    }
    ...
    {
        $this->assertNull($this->createValueFilter('foo')->asText(LengthRange::minOnly(5)));
    }
    ...
    {
        $this->createValueFilter('foo')->asText(LengthRange::minOnly(5));
        $this->assertTrue($this->paramErrors->existFor('bar'));
    }
    ...
    {
        $this->assertEquals('foo<b>', $this->createValueFilter('foo<b>')->asText(null, null, false, array('b')));
    ...
    public function asHttpUriReturnsDefaultIfParamIsNullAndNotRequired()
    {
        $this->assertEquals('http://example.com/',
                            $this->createValueFilter(null)->asHttpUri(HttpUri::fromString('http://example.com/'))
                                                          ->asString()
        );
    }
    ...
    {
        $this->assertNull($this->createValueFilter(null)->asHttpUri(null, true));
    }
    ...
    {
        $this->createValueFilter(null)->asHttpUri(null, true);
        $this->assertTrue($this->paramErrors->existForWithId('bar', 'FIELD_EMPTY'));
    }
    ...
    {
        $this->assertEquals('http://example.com/',
                            $this->createValueFilter(null)->asExistingHttpUri(HttpUri::fromString('http://example.com/'))
                                                          ->asString()
        );
    }
    ...
    {
        $this->assertNull($this->createValueFilter(null)->asExistingHttpUri(null, true));
    }
    ...
    {
        $this->createValueFilter(null)->asExistingHttpUri(null, true);
        $this->assertTrue($this->paramErrors->existForWithId('bar', 'FIELD_EMPTY'));
    }
    ...
    {
        $default = Date::now();
        $this->assertEquals($default, $this->createValueFilter(null)->asDate(null, $default));
    }
    ...
    {
        $this->assertNull($this->createValueFilter(null)->asDate(null, Date::now(), true));
    }
    ...
    {
        $this->createValueFilter(null)->asDate(null, Date::now(), true);
        $this->assertTrue($this->paramErrors->existForWithId('bar', 'FIELD_EMPTY'));
    }
    ...
    public function asDateReturnsNullIfParamIsOutOfRange()
    {
        $this->assertNull($this->createValueFilter(new Date('yesterday'))
                               ->asDate(DateRange::minOnly(Date::now()))
        );
    }
    ...
    public function ifIsHttpUriReturnsDefaultValueIfValidationFails()
    {
        $this->assertEquals('http://example.org/',
                            $this->createValueFilter('invalid')->ifIsHttpUri('http://example.org/')
        );
    }
    ...
    {
        $this->assertEquals('http://example.org/',
                            $this->createValueFilter(null)->ifIsHttpUri('http://example.org/')
        );
    }
    ...
    {
        $this->assertEquals('http://localhost/',
                            $this->createValueFilter('http://localhost/')->ifIsExistingHttpUri()
        );
    }
    ...
    {
        $this->assertNull($this->createValueFilter('invalid')->ifIsExistingHttpUri());
    }
    ...
    {
        $this->assertEquals('http://example.org/',
                            $this->createValueFilter('invalid')->ifIsExistingHttpUri('http://example.org/')
        );
    }
    ...
    {
        $this->assertEquals('http://example.org/',
                            $this->createValueFilter(null)->ifIsExistingHttpUri('http://example.org/')
        );
    }
